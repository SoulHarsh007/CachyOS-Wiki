...
- *Cachy Browser due to it's nature of leaning towards privacy. Disables WebGL by default and GitHub needs it for rendering their homepage*
...
- *No. This is because we include a [policies file](https://github.com/CachyOS/CachyOS-Browser-Settings/blob/master/distribution/policies.json) on which we disable features and add modifications to the browser. That's why you get this information dialog.*
